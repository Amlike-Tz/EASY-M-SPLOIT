...
cd $HOME && cd EASY-M-SPLOIT
bash banner.sh
sleep 5.0
echo "KUINSTALL M-SPLOIT KATIKA SIM YAKO INAHITAJ MDA. INAWEZA CHUKUA ATA DAKIKA 50 KULINGANA NA SPEED YA INTERNET YAKO"
if [ -d $HOME/metasploit-framework ];
then
echo "KAMA TEAR KWENY SIM YAKO KUNA METASPLOIT ITAKUA REMOVED..."
